...
export default function SubCommitteeMemberForm() {
  ...
  const handleSubmit = (
    ...
    const request =
      editingId
        ? AxiosInstance.patch(
            `admin/committee/sub-members/${editingId}/`,
            fd,
            {
              headers:
                {
  ...
  const handleDelete = (
    ...
    AxiosInstance.delete(
      `admin/committee/sub-members/${id}/`
    )
      .then(
        fetchMembers
      )
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-md border p-6 mb-10">
        <h3 className="text-xl font-semibold mb-6">
          {editingId
            ? "Edit Sub Committee Member"
            : "Add Sub Committee Member"}
        </h3>
