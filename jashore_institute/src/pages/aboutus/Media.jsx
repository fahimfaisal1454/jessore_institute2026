...
export default function Media() {
  ...
  const [title, setTitle] = useState("মিডিয়া তথ্য");
  ...
  useEffect(() => {
    const fetchMedia = async () => {
      try {
        const res = await AxiosInstance.get("aboutus/media/");

        setMediaData(res.data.media || []);
        setTitle(res.data.title || "মিডিয়া তথ্য");
