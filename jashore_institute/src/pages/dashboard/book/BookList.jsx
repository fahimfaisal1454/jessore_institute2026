      ...
      <div className="overflow-x-auto border rounded-lg">
        <table className="w-full min-w-[3200px] border-collapse text-xs">
          <thead className="bg-blue-900 text-white">
            <tr>
              {[
                "ক্রমিক","BarCode","বইয়ের নাম","লেখকের নাম","সম্পাদকের নাম","অনুবাদকের নাম","প্রকাশকের নাম","প্রকাশ স্থান","প্রকাশের তারিখ","বইয়ের শ্রেণী","সংযোজন সংখ্যা","বইয়ের পৃষ্ঠা","বইয়ের মূল্য","বইয়ের মাধ্যম","ফ্লোর","র‍্যাক","কত তলা","আলমারি","বারকোড","মন্তব্য","Created By","Create Date","Edit","Delete"
              ].map((head, idx) => (
